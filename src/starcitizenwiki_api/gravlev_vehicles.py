...
_BASE = "https://api.star-citizen.wiki/api/gravlev-vehicles"


@dataclass(frozen=True)
class GravlevVehicle:
    uuid: str | None
    name: str
    slug: str | None
    ...
    @classmethod
    def from_api(cls, data: dict[str, Any], locale: str = DEFAULT_LOCALE) -> GravlevVehicle:
...
class GravlevVehicles(WikiResource[GravlevVehicle]):
    endpoint = _BASE
    model = GravlevVehicle
    noun = "gravlev vehicle"
